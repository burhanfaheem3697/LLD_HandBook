...
- Knowledge dependency graph: [P00.M02.L03](P00.M02.L03.md) depends on $depends; unlocks $unlocks; future applications include framework internals, production design reviews, and open-source reading.
...
- Primary lecture: use [22_RESOURCE_CATALOG.md](../../22_RESOURCE_CATALOG.md), Video Track P00, selecting the lecture whose topic is closest to "JUnit basics and executable examples".
...
- Chapters and sections: use the chapter mapping in [22_RESOURCE_CATALOG.md](../../22_RESOURCE_CATALOG.md) for Phase 0; choose the row matching "JUnit basics and executable examples".
...
Build a small Java exercise named after [P00.M02.L03](P00.M02.L03.md):
...
- Professional mistakes: optimizing for current convenience while damaging API stability, or future migration.
