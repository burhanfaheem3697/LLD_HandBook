...
- Knowledge dependency graph: [P00.M04.L01](P00.M04.L01.md) depends on $depends; unlocks $unlocks; future applications include framework internals, production design reviews, and open-source reading.
...
- Primary lecture: use [22_RESOURCE_CATALOG.md](../../22_RESOURCE_CATALOG.md), Video Track P00, selecting the lecture whose topic is closest to "Debugging with breakpoints and watches".
...
- Chapters and sections: use the chapter mapping in [22_RESOURCE_CATALOG.md](../../22_RESOURCE_CATALOG.md) for Phase 0; choose the row matching "Debugging with breakpoints and watches".
...
Build a small Java exercise named after [P00.M04.L01](P00.M04.L01.md):
