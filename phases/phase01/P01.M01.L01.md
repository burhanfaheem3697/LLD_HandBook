...
- Knowledge dependency graph: [P01.M01.L01](P01.M01.L01.md) depends on $depends; unlocks $unlocks; future applications include framework internals, production design reviews, and open-source reading.
...
- Primary lecture: use [22_RESOURCE_CATALOG.md](../../22_RESOURCE_CATALOG.md), Video Track P01, selecting the lecture whose topic is closest to "Classes, objects, identity, and state".
...
- Chapters and sections: use the chapter mapping in [22_RESOURCE_CATALOG.md](../../22_RESOURCE_CATALOG.md) for Phase 1; choose the row matching "Classes, objects, identity, and state".
...
Build a small Java exercise named after [P01.M01.L01](P01.M01.L01.md):
