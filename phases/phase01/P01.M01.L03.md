...
- Knowledge dependency graph: [P01.M01.L03](P01.M01.L03.md) depends on $depends; unlocks $unlocks; future applications include framework internals, production design reviews, and open-source reading.
...
- Primary lecture: use [22_RESOURCE_CATALOG.md](../../22_RESOURCE_CATALOG.md), Video Track P01, selecting the lecture whose topic is closest to "Value objects, entities, and records".
...
- Chapters and sections: use the chapter mapping in [22_RESOURCE_CATALOG.md](../../22_RESOURCE_CATALOG.md) for Phase 1; choose the row matching "Value objects, entities, and records".
...
Build a small Java exercise named after [P01.M01.L03](P01.M01.L03.md):
